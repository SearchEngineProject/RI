...
-->
    ...
    <div class="moreindent">
      <form action="${ds}/${srvQuery}" method="GET"  accept-charset="UTF-8">
        <textarea name="query" cols="70" rows="10">PREFIX : <http://ontologies.alwaysdata.net/space#>
...
LIMIT 20</textarea>
    ...
    <div class="moreindent">
      <form action="${ds}/${srvUpdate}" method="post" accept-charset="UTF-8">
        <textarea name="update" cols="70" rows="10">PREFIX : <http://ontologies.alwaysdata.net/space#>
PREFIX rdf:  <http://www.w3.org/1999/02/22-rdf-syntax-ns#>
PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
PREFIX owl:  <http://www.w3.org/2002/07/owl#>
PREFIX xsd:  <http://www.w3.org/2001/XMLSchema#>
